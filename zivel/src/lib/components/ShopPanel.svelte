<script lang="ts">
  ...
  let shopItems: ShopItem[] = [
    ...
    { 
      id: 2, 
      name: 'Ledové jméno', 
      description: 'Mrazivý styl s modrým gradientem', 
      price: 150, 
      type: 'name_style',
      owned: false 
    },
    { 
      id: 3, 
      name: 'Přírodní jméno', 
      description: 'Svěží zelený gradient jako les', 
      price: 150, 
      type: 'name_style',
      owned: false 
    },
    ...
    { 
      id: 5, 
      name: 'Ohnivé jméno', 
      description: 'Žhavý červeno-oranžový efekt', 
      price: 175, 
      type: 'name_style',
      owned: false 
    },
    { 
      id: 6, 
      name: 'Bleskové jméno', 
      description: 'Elektrizující žlutobílý efekt', 
      price: 250, 
      type: 'name_style',
      owned: false 
    },
    { 
      id: 7, 
      name: 'Mystické jméno', 
      description: 'Magický fialovo-modrý přechod', 
      price: 200, 
      type: 'name_style',
      owned: false 
    },
    { 
      id: 8, 
      name: 'Kamenné jméno', 
      description: 'Šedivý kamenný vzhled s kurzívou', 
      price: 100, 
      type: 'name_style',
      owned: false 
    },
  ...
  // Reaktivní aktualizace vlastnictví
  $: shopItems = shopItems.map(item => ({
    ...item,
    owned: purchasedItems.some(pi => pi.id === item.id)
  }));
  ...
  async function buyItem(item: ShopItem) {
    ...
    shopItems = shopItems.map(i => i.id === item.id ? {...i, owned: true} : i);
  }
